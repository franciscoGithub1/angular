...
var AccountProviders = [_login_login_service__WEBPACK_IMPORTED_MODULE_10__["LoginService"], _shared_service_proxies_service_proxies__WEBPACK_IMPORTED_MODULE_12__["TokenAuthServiceProxy"]];
var AccountComponents = [_account_component__WEBPACK_IMPORTED_MODULE_13__["AccountComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_14__["LoginComponent"], _password_recovery_password_recovery_component__WEBPACK_IMPORTED_MODULE_15__["PasswordRecoveryComponent"]];
var AccountEntryComponents = [_shared_plus_dialog_custom_dialog_component__WEBPACK_IMPORTED_MODULE_11__["CustomDialogComponent"]];
// export for routing
...
var AccountComponent = /** @class */ (function (_super) {
    ...
    function AccountComponent(injector, _loginService) {
        ...
        _this.versionText = _this.appSession.application.version + ' [' + _this.appSession.application.releaseDate.format('YYYYMMDD') + ']';
        return _this;
    }
...
var AccountModule = /** @class */ (function () {
    ...
    AccountModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_account_routing__WEBPACK_IMPORTED_MODULE_4__["routes"])].concat(_account_barrel__WEBPACK_IMPORTED_MODULE_2__["AccountImports"]),
...
var LoginComponent = /** @class */ (function (_super) {
    ...
    function LoginComponent(injector, loginService, _sessionService, matDialog) {
        var _this = _super.call(this, injector) || this;
        _this.loginService = loginService;
        _this._sessionService = _sessionService;
        _this.matDialog = matDialog;
        _this.userLanguage = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
        _this.submitting = false;
        _this.email = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email]);
        _this.password = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
        _this.rememberMe = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
        return _this;
    }
    LoginComponent.prototype.ngOnInit = function () {
        this.languages = Object(lodash__WEBPACK_IMPORTED_MODULE_7__["filter"])(this.localization.languages, function (l) { return !l.isDisabled; });
    ...
    LoginComponent.prototype.changeLanguage = function (languageName) {
    ...
    LoginComponent.prototype.validaLogin = function () {
        this.email.markAsTouched();
        this.password.markAsTouched();
        return this.email.valid && this.password.valid;
    };
    LoginComponent.prototype.getTenancyName = function (email) {
        var domain = email.substring(email.lastIndexOf('@') + 1);
        console.log(domain);
        var tenancyName = domain.substring(0, domain.lastIndexOf('.'));
...
}(_shared_app_component_base__WEBPACK_IMPORTED_MODULE_5__["AppComponentBase"]));
...
var LoginService = /** @class */ (function () {
    function LoginService(_tokenAuthService, _router, _utilsService, _tokenService, _logService, _sessionService) {
...
var PasswordRecoveryComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PasswordRecoveryComponent, _super);
    function PasswordRecoveryComponent(injector, _router, snackBar, _tokenAuthService) {
        var _this = _super.call(this, injector) || this;
        _this._router = _router;
        _this.snackBar = snackBar;
        _this._tokenAuthService = _tokenAuthService;
        _this.passwordMinLenght = 6;
        _this.securityCodeMinLenght = 4;
        _this.email = '';
        _this.password = '';
        _this.reEnteredPassword = '';
        _this.securityKey = '';
        _this.resultMessage = '';
        _this.ok = true;
        _this.okMessage = false;
        _this.stepper = true;
        _this.emailValidator = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(_shared_plus_regex_plus_regex_component__WEBPACK_IMPORTED_MODULE_6__["PlusRegexModule"].email)]);
        _this.passwordValidator = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(_this.passwordMinLenght)]);
        _this.reEnteredPasswordValidator = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(_this.passwordMinLenght)]);
        _this.securityCodeValidator = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(_this.securityCodeMinLenght)]);
        return _this;
    }
    PasswordRecoveryComponent.prototype.ValidarFofmulario = function (stepper, step) {
        if (step === 1) {
    ...
    PasswordRecoveryComponent.prototype.ObtenerCodigoDeSeguridad = function (stepper) {
        var _this = this;
        this.emailValidator.markAsTouched({ onlySelf: true });
        var input = new _shared_service_proxies_service_proxies__WEBPACK_IMPORTED_MODULE_7__["RecoveryPasswordInputDto"]();
        ...
        this._tokenAuthService
            ...
            .subscribe(function () {
            _this.snackBar.open(_this.l('RecoveryPasswordMailSended'), '', { duration: 3500 });
            stepper.next();
        });
    };
    PasswordRecoveryComponent.prototype.CambiarContrasena = function (stepper) {
        var _this = this;
        var ok = true;
        ...
        if (ok === false) {
            ...
            var input = new _shared_service_proxies_service_proxies__WEBPACK_IMPORTED_MODULE_7__["UpdatePasswordInputDto"]();
            ...
            this._tokenAuthService
                ...
                .subscribe(function () {
                _this.okMessage = true;
                _this.stepper = false;
            });
        }
    };
    PasswordRecoveryComponent.prototype.ValidateCambiarContrasenaData = function () {
        var ok = true;
        ok = ok && !this.passwordValidator.hasError('required');
        ok = ok && !this.reEnteredPasswordValidator.hasError('required');
        var passwordAreEquals = this.password === this.reEnteredPassword;
...
var PlusRegexModule = /** @class */ (function () {
    function PlusRegexModule() {
    }
