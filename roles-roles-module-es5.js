...
var RolesFormComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RolesFormComponent, _super);
    function RolesFormComponent(injector, route, router, builder, database) {
    ...
    RolesFormComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.route.data.subscribe(function (data) {
            ...
            if (_this.item) {
                _this.form.patchValue(_this.item);
            }
        });
    };
    RolesFormComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.form.valid) {
            this.isSaving = true;
            this.database
...
var RolesListFilterComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RolesListFilterComponent, _super);
    function RolesListFilterComponent(injector) {
        return _super.call(this, injector) || this;
    }
    RolesListFilterComponent.prototype.ngOnInit = function () {
    ...
    return RolesListFilterComponent;
...
var RolesListComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RolesListComponent, _super);
    function RolesListComponent(injector, datasource) {
        var _this = _super.call(this, injector) || this;
...
var RolesListTableComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RolesListTableComponent, _super);
    function RolesListTableComponent(injector) {
        var _this = _super.call(this, injector) || this;
        _this.columns = ['select', 'name', 'actions'];
        return _this;
    }
    RolesListTableComponent.prototype.ngOnInit = function () {
    ...
    RolesListTableComponent.prototype.editUser = function (user) {
        // TODO update user
    };
    RolesListTableComponent.prototype.batchDelete = function () {
     ...
     * Selection Support
     */
    RolesListTableComponent.prototype.isAllSelected = function () {
        var _this = this;
        return !this.source.data.some(function (row) { return !_this.selection.isSelected(row.id); });
    };
    RolesListTableComponent.prototype.masterToggle = function () {
        var _this = this;
        var deselect = this.isAllSelected();
        this.source.data.forEach(function (row) {
            deselect ? _this.selection.deselect(row.id) : _this.selection.select(row.id);
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return RolesListTableComponent;
}(_shared_app_component_base__WEBPACK_IMPORTED_MODULE_4__["AppComponentBase"]));
...
var RolesPermissionsComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RolesPermissionsComponent, _super);
    function RolesPermissionsComponent(parent, builder, source, injector) {
        var _this = _super.call(this, injector) || this;
        _this.parent = parent;
        _this.builder = builder;
        _this.source = source;
        _this.columns = ['select', 'name'];
        _this.change = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        _this.value = [];
        _this.mandatory = _shared_AppConsts__WEBPACK_IMPORTED_MODULE_6__["AppConsts"].mandatoryPerms;
        _this._disabled = false;
        _this.propagateChange = function (data) { };
        _this.propagateTouch = function () { };
        return _this;
    }
    RolesPermissionsComponent_1 = RolesPermissionsComponent;
    RolesPermissionsComponent.prototype.ngOnInit = function () {
        ...
        if (this.formControlName) {
            var parent_1 = this.parent.control;
            var control = parent_1.get(this.formControlName);
        ...
        this.source.addOptional({
            ...
            getter: function () { return _this.form.value; }
        });
        // selection setup
        this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_1__["SelectionModel"](true, []);
        this.selection.changed.subscribe(function () { return _this.onChange(_this.selection.selected); });
    };
    RolesPermissionsComponent.prototype.onChange = function (value) {
        this.value = value;
     ...
     */
    RolesPermissionsComponent.prototype.writeValue = function (value) {
        var _a;
        if (value && value.length) {
            this.value = value;
            (_a = this.selection).select.apply(_a, value);
        }
    };
    RolesPermissionsComponent.prototype.registerOnChange = function (fn) {
        this.propagateChange = function (data) {
            fn(data);
        };
    };
    RolesPermissionsComponent.prototype.registerOnTouched = function (fn) {
        this.propagateTouch = function () {
            fn();
        };
    };
    RolesPermissionsComponent.prototype.setDisabledState = function (isDisabled) {
        this._disabled = isDisabled;
    };
    RolesPermissionsComponent.prototype.validate = function (c) {
        if (!this._disabled) {
    ...
    RolesPermissionsComponent.prototype.checkRequired = function (field) {
        if (field.validator) {
            var validator = field.validator(field);
     ...
     * Selection Support
     */
    RolesPermissionsComponent.prototype.isAllSelected = function () {
        var _this = this;
        return !this.source.data.some(function (row) { return !_this.selection.isSelected(row.name); });
    };
    RolesPermissionsComponent.prototype.masterToggle = function () {
        var _this = this;
        var deselect = this.isAllSelected();
        this.source.data.forEach(function (row) {
            return deselect
                ? _this.mandatory.indexOf(row.name) === -1 ? _this.selection.deselect(row.name) : null
                : _this.selection.select(row.name);
        });
    };
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            ...
            providers: [
                _services__WEBPACK_IMPORTED_MODULE_9__["PermissionsDatasource"],
                {
                    ...
                    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(function () { return RolesPermissionsComponent_1; }),
                    multi: true
                },
                {
...
}(_shared_app_component_base__WEBPACK_IMPORTED_MODULE_7__["AppComponentBase"]));
...
/* harmony import */ var _matheo_datasource__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @matheo/datasource */ "../../node_modules/@matheo/datasource/fesm5/matheo-datasource.js");
...
var RolesModule = /** @class */ (function () {
    ...
    RolesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            ].concat(_roles_barrel__WEBPACK_IMPORTED_MODULE_4__["RolesImports"]),
...
var PermissionsDatabase = /** @class */ (function () {
    function PermissionsDatabase(roles) {
        this.roles = roles;
        this.perms = [];
    }
    PermissionsDatabase.prototype.getAll = function (args) {
        var _this = this;
        var offset = args.pageIndex * args.pageSize;
        var limit = args.pageSize;
        var response = function () {
            // filter the list if there's a query
            var perms = args.query
                ? _this.perms.filter(function (perm) {
                    var regex = new RegExp(args.query, 'i');
        ...
        if (this.perms.length) {
            ...
            return this.roles.getAllPermissions().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (perms) { return (_this.perms = perms.items); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return response(); }));
        }
    };
    PermissionsDatabase.prototype.save = function (item) {
        return item.id
...
var PermissionsDatasource = /** @class */ (function (_super) {
    ...
    function PermissionsDatasource(database) {
    ...
    PermissionsDatasource.prototype.rawDefault = function () {
        return {
            totalCount: 0,
            items: []
        };
    };
    PermissionsDatasource.prototype.rawFetch = function (args) {
        return this.database.getAll(args);
    };
    PermissionsDatasource.prototype.rawTotal = function (result) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(result.totalCount);
    };
    PermissionsDatasource.prototype.rawResult = function (result) {
        return result.items;
    };
    PermissionsDatasource.prototype.filter = function (query, limit) {
        throw new Error('Not Implemented');
    };
    PermissionsDatasource.prototype.resFilter = function (result) {
        throw new Error('Not Implemented');
    };
...
var RolesDatabase = /** @class */ (function () {
    function RolesDatabase(roles) {
        this.roles = roles;
    }
    RolesDatabase.prototype.get = function (id) {
        return this.roles.get(id);
    };
    RolesDatabase.prototype.getAll = function (args) {
...
var RolesDatasource = /** @class */ (function (_super) {
    ...
    function RolesDatasource(database) {
        var _this = _super.call(this) || this;
        _this.database = database;
        _this.config = {
            debug: false,
    ...
    RolesDatasource.prototype.rawDefault = function () {
        return {
            totalCount: 0,
            items: []
        };
    };
    RolesDatasource.prototype.rawFetch = function (args) {
        return this.database.getAll(args);
    };
    RolesDatasource.prototype.rawTotal = function (result) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(result.totalCount);
    };
    RolesDatasource.prototype.rawResult = function (result) {
        return result.items;
    };
    RolesDatasource.prototype.filter = function (query, limit) {
        throw new Error('Not Implemented');
    };
    RolesDatasource.prototype.resFilter = function (result) {
        throw new Error('Not Implemented');
    };
...
var RolesResolver = /** @class */ (function () {
    function RolesResolver(router, database) {
        this.router = router;
        this.database = database;
    }
    RolesResolver.prototype.resolve = function (route) {
        var _this = this;
...
var RolesWrapperComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RolesWrapperComponent, _super);
    function RolesWrapperComponent(injector, datasource) {
        var _this = _super.call(this, injector) || this;
        _this.datasource = datasource;
        return _this;
    }
    RolesWrapperComponent.prototype.ngOnInit = function () {
    };
...
var FormUtils = /** @class */ (function () {
     ...
     */
    FormUtils.pruneEmpty = function (obj) {
     ...
     */
    FormUtils.isRequired = function (field) {
        if (field.validator) {
            var validator = field.validator(field);
            if (validator && validator.required) {
                return true;
     ...
     */
    FormUtils.updateValidity = function (group) {
     ...
     */
    FormUtils.markAsTouched = function (group) {
        Object.keys(group.controls).map(function (field) {
            var control = group.get(field);
            if (control instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]) {
     ...
     * @param group Form to mark as touched
     */
    FormUtils.getErrors = function (group, errors) {
