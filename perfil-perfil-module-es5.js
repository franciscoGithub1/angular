...
var PerfilFormComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PerfilFormComponent, _super);
    function PerfilFormComponent(injector) {
        var _this = _super.call(this, injector) || this;
        _this.isPinSent = false;
        _this.isSaving = false;
        return _this;
    }
    PerfilFormComponent.prototype.ngOnInit = function () { };
    PerfilFormComponent.prototype.onPasswordChange = function () {
        // TODO consume RecuperarPassword
        // TODO show snack
        this.isPinSent = true;
    };
    PerfilFormComponent.prototype.onSubmit = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])((this.isSaving = true))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () { return _this.cmpUser.submit(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () { return (_this.isPinSent ? _this.cmpPass.submit() : Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(true)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(err); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])())
            .subscribe(function () {
            // TODO show snack
        }, function () {
...
var PerfilFormPasswordComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PerfilFormPasswordComponent, _super);
    function PerfilFormPasswordComponent(injector, builder) {
        var _this = _super.call(this, injector) || this;
        _this.builder = builder;
        _this.channels = [
            { value: '', title: _super.prototype.l.call(_this, 'value.default') }
        ];
        _this.tenants = [
            { value: '', title: _super.prototype.l.call(_this, 'value.default') }
        ];
    ...
    PerfilFormPasswordComponent.prototype.ngOnInit = function () {
    ...
    PerfilFormPasswordComponent.prototype.validate = function (form) {
        var password = form.get('newPassword').value;
        var confirm = form.get('repeatPassword').value;
        var oneLowercaseLetter = password.match('(?=.*[a-z])');
        var oneUppercaseLetter = password.match('(?=.*[A-Z])');
        var oneNumber = password.match('(?=.*[0-9])');
        var oneSpecialChar = password.match('(?=.*[^a-zA-Z0-9])');
        var hasMinLength = password.length >= 8;
        var hasMaxLength = password.length <= 16;
        var passwordMatch = password ? password === confirm : false;
        var error = null;
    ...
    PerfilFormPasswordComponent.prototype.submit = function () {
        if (!this.form.dirty) {
    ...
    return PerfilFormPasswordComponent;
...
var PerfilFormUserComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PerfilFormUserComponent, _super);
    function PerfilFormUserComponent(injector, builder, user, session) {
        var _this = _super.call(this, injector) || this;
        _this.builder = builder;
        _this.user = user;
    ...
    PerfilFormUserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.form = this.builder.group({
            agenteId: null,
            userId: null,
        ...
        this.user.obtener(this.session.userId).subscribe(function (perfil) {
            _this.perfil = perfil;
            _this.form.patchValue(perfil.agenteDto);
            // fill channels and tenants
            var mapTenant = function (sc) { return ({
                value: sc.sucursalId,
                title: sc.nombre
            }); };
            var mapChannel = function (ch) { return ({
                value: ch.canalId,
                title: ch.nombre,
                tenants: ch.sucursalesDtos.map(mapTenant)
            }); };
            _this.channels = perfil.canalesDtos.map(mapChannel);
            // patch channel and tenant
            var channel = Object(lodash__WEBPACK_IMPORTED_MODULE_6__["find"])(perfil.canalesDtos, function (ch) { return ch.sucursalesDtos.some(function (sc) { return sc.mcaPrincipal; }); });
            if (channel) {
                _this.form.patchValue({ channel: mapChannel(channel) });
                var tenant = Object(lodash__WEBPACK_IMPORTED_MODULE_6__["find"])(channel.sucursalesDtos, function (sc) { return sc.mcaPrincipal; });
                if (tenant) {
                    _this.form.patchValue({ tenant: mapTenant(tenant) });
                }
            }
        });
    };
    PerfilFormUserComponent.prototype.compareWith = function (option, selected) {
        return option.value === selected.value;
    };
    PerfilFormUserComponent.prototype.submit = function () {
        if (!this.form.dirty) {
    ...
    return PerfilFormUserComponent;
}(_shared_app_component_base__WEBPACK_IMPORTED_MODULE_3__["AppComponentBase"]));
...
var PerfilModule = /** @class */ (function () {
    ...
    PerfilModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            ].concat(_perfil_barrel__WEBPACK_IMPORTED_MODULE_4__["PerfilImports"]),
